...
- 9a63a7a: Deal form: stable `data-testid` and `data-field` hooks for the Explorer harness (#88)
...
- a510869: The add-product dialog no longer invents an order when the deal's own one cannot be resolved.
